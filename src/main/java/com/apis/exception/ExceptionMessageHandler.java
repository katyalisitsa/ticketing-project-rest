...
import com.apis.dto.DefaultExceptionMessageDto;
...
public class ExceptionMessageHandler {
    ...
    private Optional<DefaultExceptionMessageDto> getMessageFromAnnotation(Method method) {
        com.apis.annotation.DefaultExceptionMessage defaultExceptionMessage = method.getAnnotation(com.apis.annotation.DefaultExceptionMessage.class);
